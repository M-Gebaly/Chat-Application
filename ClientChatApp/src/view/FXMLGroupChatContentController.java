 ...
 * @author M.Gebaly
 */
public class FXMLGroupChatContentController implements Initializable {
...
//                                {
                                    ...
                                    message.setContent(user.getName()+": "+message_txt.getText());
...
//                                    message.setToEmail(friendUser.getEmail());
                                    ...
                                    server.sendGroupMessage(message, groupId, groupName, groupList);
...
//                                }
                                ...
                                Logger.getLogger(FXMLGroupChatContentController.class.getName()).log(Level.SEVERE, null, ex);
                            }                    
                        }
                    }
                });
